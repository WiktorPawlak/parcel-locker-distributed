...
import static pl.pas.domain.core.applicationmodel.model.delivery.DeliveryStatus.READY_TO_SHIP;
...
import pl.pas.domain.rest.controllers.dto.ListDto;
import pl.pas.domain.rest.controllers.dto.LockerDto;
import pl.pas.domain.rest.controllers.dto.ParcelDto;

class DeliveryControllerTest extends DbContainerInitializer {
